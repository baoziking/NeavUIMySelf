...
-- Needs review
ERROR_FRAME_FAILED = "同步 %s 時發生錯誤。要再次調整這個框架之前，請重置框架並且 /reload ，便可以解決這個問題。選項設定中可以停用這個訊息，但若持續發生這個問題，請向作者回報下列資訊： %s %s %s",
-- Needs review
ERROR_MODULE_FAILED = "調整 %s - %s 時發生錯誤。選項設定中可以停用這個訊息，但若持續發生這個問題，請向作者回報下列資訊： %s %s %s",
