...
local m = {
	...
	LoadList = function(self)
		...
		API:AddElement({name = "MainMenuBarArtFrameLeftEndCapMover", displayName = "左邊獅鷲圖案", noScale = 1}, c)
		API:AddElement({name = "MainMenuBarArtFrameRightEndCapMover", displayName = "右邊獅鷲圖案", noScale = 1}, c)
