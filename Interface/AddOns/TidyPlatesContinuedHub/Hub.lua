...
local function BuildHubPanel(panel)
    ...
    panel.TextShowOnlyOnActive, F = CreateQuickCheckbutton(objectName.."TextShowOnlyOnActive", "激活或受伤的单位显示信息文字", AlignmentColumn, F, 0)
	...
	panel.WidgetDebuff = CreateQuickCheckbutton(objectName.."WidgetDebuff", "启用光环组件", AlignmentColumn, panel.DebuffsLabel)
	...
	panel.WidgetMyDebuff = CreateQuickCheckbutton(objectName.."WidgetMyDebuff", "包括我的Debuff", AlignmentColumn, panel.WidgetDebuff, 16)
	panel.WidgetMyBuff = CreateQuickCheckbutton(objectName.."WidgetMyBuff", "包括我的Buff", AlignmentColumn, panel.WidgetMyDebuff, 16)
	panel.WidgetPandemic = CreateQuickCheckbutton(objectName.."WidgetPandemic", "高亮即将到期Debuff", AlignmentColumn, panel.WidgetMyBuff, 16)
	panel.ColorPandemic = CreateQuickColorbox(objectName.."ColorPandemic", "高亮边框颜色", AlignmentColumn, panel.WidgetMyBuff , OffsetColumnB + 64)
	panel.WidgetBuffPurgeable = CreateQuickCheckbutton(objectName.."WidgetBuffPurgeable", "包括可净化的BUFF", AlignmentColumn, panel.WidgetPandemic, 16)
	panel.ColorBuffPurgeable = CreateQuickColorbox(objectName.."ColorBuffPurgeable", "可净化边框颜色", AlignmentColumn, panel.WidgetPandemic , OffsetColumnB + 64)
	panel.WidgetBuffEnrage = CreateQuickCheckbutton(objectName.."WidgetBuffEnrage", "包括激怒BUFF", AlignmentColumn, panel.WidgetBuffPurgeable, 16)
	panel.ColorBuffEnrage = CreateQuickColorbox(objectName.."ColorBuffEnrage", "激怒边框颜色", AlignmentColumn, panel.WidgetBuffPurgeable , OffsetColumnB + 64)

	panel.WidgetDebuffListLabel = CreateQuickItemLabel(nil, "额外的光环:", AlignmentColumn, panel.WidgetBuffEnrage, 16)
	...
	panel.WidgetAuraTrackDispelFriendly = CreateQuickCheckbutton(objectName.."WidgetAuraTrackDispelFriendly", "包括在友方单位上的可驱散的Debuff", AlignmentColumn, panel.WidgetDebuffStyle, 16, 4)
	...
	panel.DebuffHelpTip = CreateQuickItemLabel(nil, "友情提示: |cffCCCCCC请填写法术的确切名称，或法术ID编号。"..
		...
		"前缀添加'Not'可用来添加法术监控黑名单，法术监控以从上到下的顺序优先显示。", AlignmentColumn, panel.WidgetDebuffListLabel, 225+40) -- 210, 275, )
...
--]]
	...
	panel.WidgetThreatIndicator, F = CreateQuickCheckbutton(objectName.."WidgetThreatIndicator", "显示仇恨指示器", AlignmentColumn, panel.ColorThreatSafe, 0, 2)
	...
	--Widgets
	------------------------------
	panel.WidgetLabel, F = CreateQuickHeadingLabel(nil, "其他", AlignmentColumn, F, 0, 5)
	panel.WidgetTargetHighlight = CreateQuickCheckbutton(objectName.."WidgetTargetHighlight", "显示目标高亮", AlignmentColumn, panel.WidgetLabel)
	...
	panel.WidgetQuestIcon = CreateQuickCheckbutton(objectName.."WidgetQuestIcon", "显示任务目标", AlignmentColumn, panel.WidgetTotemIcon)
	panel.WidgetComboPoints = CreateQuickCheckbutton(objectName.."WidgetComboPoints", "显示特殊资源", AlignmentColumn, panel.WidgetQuestIcon)
	panel.WidgetComboPointsStyle =  CreateQuickDropdown(objectName.."WidgetComboPointsStyle", "个人资源条风格:", ComboPointsStyles, 2, AlignmentColumn, panel.WidgetComboPoints, 16)

	--panel.WidgetEnableExternal = CreateQuickCheckbutton(objectName.."WidgetEnableExternal", "启用外部组件", AlignmentColumn, panel.WidgetComboPoints)

	--panel.WidgetThreatIndicatorMode =  CreateQuickDropdown(objectName.."WidgetThreatIndicatorMode", "仇恨指示器:", ThreatWidgetModes, 1, AlignmentColumn, panel.WidgetThreatIndicator, OffsetColumnB+16)
	...
	panel.WidgetRangeIndicator = CreateQuickCheckbutton(objectName.."WidgetRangeIndicator", "显示队伍距离警告", AlignmentColumn, panel.WidgetAbsorbUnits, OffsetColumnB+60)
	...
	-- Advanced
	------------------------------
	panel.AdvancedLabel, F = CreateQuickHeadingLabel(nil, "高级", AlignmentColumn, panel.WidgetComboPointsStyle, 0, 5)
	...
	panel.NameplateMaxDistance, F = CreateQuickSlider(objectName.."NameplateMaxDistance", "姓名版显示距离（默认值：60码）", AlignmentColumn, F, 0, 4)
