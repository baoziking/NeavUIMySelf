...
AddHubFunction(EnemyNameSubtextFunctions, TidyPlatesContHubMenus.EnemyNameSubtextModes, TextRoleGuildLevel, "NPC头衔、公会和等级", "RoleGuildLevel")
...
AddHubFunction(FriendlyNameSubtextFunctions, TidyPlatesContHubMenus.FriendlyNameSubtextModes, TextRoleGuild, "头衔或公会", "RoleGuild")
...
AddHubFunction(FriendlyNameSubtextFunctions, TidyPlatesContHubMenus.FriendlyNameSubtextModes, TextAll, "头衔、公会、等级或生命百分比", "RoleGuildLevelHealth")
--]]
