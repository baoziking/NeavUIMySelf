...
local function BuildInterfacePanel(panel)
	...
	panel.FirstSpecLabel:SetText("第一专精")
	...
	panel.ThirdSpecLabel:SetText("第三专精")
	...
	panel.SecondSpecLabel:SetText("第二专精")
	...
	panel.FourthSpecLabel:SetText("第四专精")
	...
	ResetButton:SetScript("OnClick", function()
		...
		if IsShiftKeyDown() then
			...
			OnRefresh(panel)
			ApplyPanelSettings()
			print(yellow.."正在重置"..orange.."Tidy Plates Continued"..yellow.."的主题选项。")
			print(yellow.."按住"..blue.."Shift"..yellow.."后点击"..red.."重置所有设置"..yellow.."按钮将清除所有设置、缓存并重载UI。")
		end
